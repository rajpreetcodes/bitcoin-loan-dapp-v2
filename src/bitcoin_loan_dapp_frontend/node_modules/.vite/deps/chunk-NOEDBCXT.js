...
var require_buffer = __commonJS({
  "../../node_modules/borc/node_modules/buffer/index.js"(exports) {
    ...
    Buffer.prototype.writeUintLE = Buffer.prototype.writeUIntLE = function writeUIntLE2(value3, offset, byteLength2, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) {
    ...
    Buffer.prototype.writeIntLE = function writeIntLE2(value3, offset, byteLength2, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      if (!noAssert) {
...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-KNLSXSRY.js");
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-NOEDBCXT.js.map
