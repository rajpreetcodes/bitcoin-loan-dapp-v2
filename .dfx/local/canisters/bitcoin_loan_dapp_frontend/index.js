...
import { idlFactory } from './bitcoin_loan_dapp_frontend.did.js';
export { idlFactory } from './bitcoin_loan_dapp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BITCOIN_LOAN_DAPP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bitcoin_loan_dapp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bitcoin_loan_dapp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bitcoin_loan_dapp_frontend.did.js")._SERVICE>}
 */
export const bitcoin_loan_dapp_frontend = createActor(canisterId);
