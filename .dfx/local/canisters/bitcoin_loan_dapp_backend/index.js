...
export const canisterId = process.env.CANISTER_ID_BITCOIN_LOAN_DAPP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bitcoin_loan_dapp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bitcoin_loan_dapp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bitcoin_loan_dapp_backend.did.js")._SERVICE>}
 */
